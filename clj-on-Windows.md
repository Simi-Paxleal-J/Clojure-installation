...
* https://download.clojure.org/install/win-install-1.10.1.502.ps1

When you run the installer, you will be prompted with several possible install locations:

```
PS Y:\Downloads> .\win-install-1.10.1.502.ps1
...
```powershell.exe -noprofile -executionpolicy bypass -file .\win-install-1.10.1.502.ps1```
